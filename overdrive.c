...
{
    Overdrive * ap = gnuitar_memalign(1, sizeof(Overdrive));
...
activate(LV2_Handle instance) {
    ...
    * overdrive->drive = 0.0;
    * overdrive->clip = 100.0;
    * overdrive->treble = 6.0;
}
...
connect_port(LV2_Handle instance,
             ...
             void*      data)
{
    Overdrive * params = (Overdrive *) instance ;
    switch (port) {
        case INPUT:
...
run(LV2_Handle instance, uint32_t n_samples)
{
    ...
    struct distort2_params *dp = params;
